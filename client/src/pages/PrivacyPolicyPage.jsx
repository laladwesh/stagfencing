...
function PrivacyPolicyPage() {
  return (
    <Layout>
      <div className="bg-[#F3EFE9] py-14 text-center">
        <h1 className="text-3xl sm:text-4xl font-semibold text-black">Privacy Policy</h1>
        <p className="mt-2 text-sm text-gray-500">Last updated: September 12, 2025</p>
      </div>

      <article className="prose prose-neutral prose-headings:font-semibold prose-a:text-brand-orange max-w-3xl mx-auto px-4 sm:px-6 py-14 sm:py-20">
        <p>
        ...
        <ul>
          <li>
            By email:{" "}
            <a href="mailto:adityabishnoi365@gmail.com">adityabishnoi365@gmail.com</a>
          </li>
        </ul>
      </article>
    </Layout>
