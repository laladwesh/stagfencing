...
const TOC = [
  ...
  { id: "delete-your-personal-data", label: "Delete Your Personal Data" },
  ...
  return (
    <Layout>
      <div className="bg-white text-center pt-14 pb-8">
        ...
        <p className="mt-2 text-sm text-gray-500">Last updated: September 12, 2024</p>
      </div>

      <div className="max-w-5xl mx-auto px-4 sm:px-6 py-8 sm:py-10 grid grid-cols-1 lg:grid-cols-4 gap-10">
        ...
        <article className="prose prose-neutral prose-headings:font-semibold prose-a:text-brand-orange lg:col-span-3">
          ...
          <ul>
            ...
            <li>
              ...
              Agreement) refers to stagfencing.
            </li>
            <li>
            ...
            <li>
              <strong>Website</strong> refers to stagfencing, accessible from{" "}
              <a href="https://stagfencing.com.au/" target="_blank" rel="noopener noreferrer">
                https://stagfencing.com.au/
              </a>
            </li>
            <li>
          ...
          <ul>
            <li>
              By email: <a href="mailto:adityabishnoi365@gmail.com">adityabishnoi365@gmail.com</a>
            </li>
          </ul>
        </article>
      </div>
